...
const FeaturedProducts: React.FC = () => {
    return (
        <div className='container border-2 border-red-500 my-24'>
            <div>
                ...
                <div className='mt-12  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 p-2 '>
                        ...
                        '>
                            <div className='flex flex-col gap-5 items-center'>
                                ...
                                <div className='flex text-white gap-3'>
                                    <div className='flex items-center gap-2 bg-primary whitespace-nowrap py-1 px-3 rounded-md'>
                                        <span><FaCartPlus /></span>
                                        <span>Add to cart</span>
                                    </div>
                                    <div className='bg-primary flex items-center justify-center py-1 px-3 rounded-md'>
                                        <IoSearchOutline />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className='min-w-[270px] group w-full text-center border-2 border-[#EBEBEB] rounded relative overflow-hidden shadow-sm'>
                        ...
                        <div className=' h-[270px]'>
                            <img src="/Feature-products-img/img4.jpg" alt="" className='w-full h-full group-hover:scale-110  transition-all duration-300 ease-in-out ' />
                        </div>
